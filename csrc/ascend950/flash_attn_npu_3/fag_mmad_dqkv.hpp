...
public:
    ...
    using LayoutTagL0A = typename TileCopy::LayoutTagL0A; // zN
    ...
    static constexpr uint32_t SLOT_DQ = 0;
    static constexpr uint32_t SLOT_DK = 1;
    static constexpr uint32_t SLOT_DV = 2;
    static constexpr uint32_t SLOT_SPARE = 3;
...
protected:
        ...
        bool enAtomicDq, bool enAtomicDkDv)
    {
        ...
        for (uint32_t dIdx = 0; dIdx < maxLoops; dIdx++) {
            ...
            uint32_t slotDq = (dIdx & 1) ? SLOT_SPARE : SLOT_DQ;
